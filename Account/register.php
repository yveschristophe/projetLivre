...
if(!empty($_POST)){
   ...
   require_once 'inc/db.php';
    if(empty($_POST['username']|| !pref_match('/^[a-zA-Z0-9_]+$/', $_POST['username']))){
        $errors['username'] = "Votre identifiant n'est pas valide(alphanumérique)";
    }else{
...
<form action="" method="POST">
    ...
    <div class="form-group">
        <label for="username">Identifiant :</label><input type="text" name="username" class="form-control" >
    </div>
    ...
    <div class="form-group">
        <label for="password">Mot de passe :</label><input type="password" name="password" class="form-control" >
    </div>

    <div class="form-group">
        <label for="confirmpass">Confirmer votre mot de passe :</label><input type="password" name="confirmpass" class="form-control" >
    </div>
